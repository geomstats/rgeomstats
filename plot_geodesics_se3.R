...
#This is commented out for now because no R version of visualization.py exists
#import geomstats.visualization as visualization
#from geomstats.special_euclidean_group import SpecialEuclideanGroup


SE3_GROUP = SpecialEuclideanGroup(n=3) #No SpecialEuclideanGroup.r exists yet
METRIC = SE3_GROUP.left_canonical_metric

main = function(){
  initial_point = SE3_GROUP.identity
  initial_tangent_vec = c(1.8, 0.2, 0.3, 3, 3, 1)
